...
from hyper_img.hyperImg_functions.get_graphics_funcs import get_boxplot_graphs, get_features_wavelenght_graph, \
                                                            ...
                                                            get_em_algorithm_clustering_graph, create_folder_with_all_graphs, get_stat_tests_graph,\
...
__all__ = ['get_df_graphics_features_wavelenght', 'get_df_pca_and_explained_variance',
           'get_google_table_sheets', 'get_boxplot_values', 'get_anova_df', 'get_stat_tests_df',
           ...
           'get_df_em_algorithm_clustering', 'get_df_umap', 'get_em_algorithm_clustering_graph', 'get_stat_tests_graph',
